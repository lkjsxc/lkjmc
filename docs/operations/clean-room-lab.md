...
recursive credential scan. Literal printf placeholders in authored URL templates and tool diagnostic
prose after an authentication keyword are not credential values. A lane fails
