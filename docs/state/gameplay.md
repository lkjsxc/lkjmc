...
| Correlation-safe economy settlement | [economy](../product/economy/README.md) | `crates/lkjmc-store/src/shop/settlement.rs`; `crates/lkjmc-store/src/exchange/reconciliation.rs`; `platforms/jvm/paper/src/main/java/com/lkjmc/paper/ShopCommandAdapter.java`; `platforms/jvm/paper/src/main/java/com/lkjmc/paper/ExchangeCommandAdapter.java` | `crates/lkjmc-store/tests/safe_economy.rs`; `crates/lkjmc-daemon/src/commands/player_shop_tests.rs`; `platforms/jvm/paper/src/test/java/com/lkjmc/paper/ShopCommandAdapterTest.java`; `platforms/jvm/paper/src/test/java/com/lkjmc/paper/ExchangeCommandAdapterTest.java` | `LKJMC_PLAYABLE_SMOKE=1 LKJMC_ACCEPT_MINECRAFT_EULA=1 ./scripts/check-playable-smoke.sh` | Plugin transfer messages establish intent only; a live transfer confirmation remains outside this adapter. | `F-SAFE-ECON` |
