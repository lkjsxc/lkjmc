...
- Immutable updater implementation commit and current committed HEAD before this ledger update: `d360c1f33e19077e5f09925dc97ff05617109e57`; base was `7323fa42ad4c118f94abf2e58e60ca120ded7207`; branch `main` is 32 commits ahead of `origin/main`. Menu implementation and deployed product release remain `b6d22115f1726aeb570e91900cabcc008ca55689`.
...
- Clean installation remains unsupported. `scripts/install.sh` now exits before mutation instead of building ambient checkout bytes. The immutable existing-deployment updater has deterministic evidence but has not yet completed its disposable-LXC or production update/no-op/restart acceptance.
