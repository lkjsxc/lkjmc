...
- Starting and current branch: `main`; starting commit: `09286e5bc57c81afefe51b8b4e9ed1ec849b18ce`; current pushed commit before image compaction: `75e88779073a0a5f18c52d408644b26c0fff2c84`.
...
- The first underlying hosted Compose verifier failure before the canonical terminal record remains unresolved. Local Docker cannot execute a container process in this outer unprivileged environment. Run `33251634060` progressed through exact release construction but could not retain scanned verifier evidence because the saved image independently failed its size bound; a new hosted run must validate compact image closure and retain bounded evidence if the verifier remains nonzero.
