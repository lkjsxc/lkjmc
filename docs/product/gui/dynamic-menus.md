...
covers `/menu`, server-list loading, travel/economy/social empty states,
party, achievements, language selection, settings daemon actions, one
player-profile menu, and no ordinary-click close.
