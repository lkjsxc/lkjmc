...
- Paper/Folia registers the commands listed in
  ...
  achievement reward claims, paid random teleport, portal cancellation, passive action-bar snapshots, persisted language caching, and save-first menu transfer work.
- Source adapters include live-data menus, true empty states, admin-gated rows,
  ...
  real save-first server transfer rows, catalog adventure rows, and typed diagnostics. Current playable
