...
use daemon-backed points purchases, `/mail` manages player mail, and moderation
commands record reports and bans through the daemon. Cross-server homes and warps
