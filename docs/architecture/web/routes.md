...
- `GET /web/observability` renders bounded health, metrics, and event summaries.
- `POST /web/support-bundle` creates a bounded private bundle and renders only its manifest.
