...
This generated file lists `admin` daemon command literals from
...
| --- | --- | --- | --- |
| `admin.audit.tail` | admin | cli, paper, velocity, web | Execute admin audit tail behavior for the admin command family. |
