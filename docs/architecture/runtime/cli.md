...
commands call daemon-backed report, warning, note, and punishment APIs. Kit,
vote, and announcement commands administer daemon-backed rewards, links, and broadcasts.
