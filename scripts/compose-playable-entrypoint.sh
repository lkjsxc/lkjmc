    ...
    cat >"$CONFIG_ROOT/lkjmc.json" <<JSON
{
  ...
  "network":{"revision":1,"instances":[{"id":"hub","owner":"lkjmc-daemon","kind":"folia","desiredState":"running","listener":"hub-java","memoryMb":1024,"assetIds":[]},{"id":"proxy","owner":"lkjmc-daemon","kind":"velocity","desiredState":"running","listener":"proxy-java","memoryMb":512,"assetIds":[]}],"routes":[{"id":"default","listener":"proxy-java","target":"hub","fallbacks":[]}],"listeners":[{"id":"hub-java","protocol":"java-tcp","bindHost":"127.0.0.1","port":25566,"publicHosts":[]},{"id":"proxy-java","protocol":"java-tcp","bindHost":"$JAVA_BIND_HOST","port":$JAVA_PORT$JAVA_PUBLIC_JSON}],"auth":{"onlineMode":$ONLINE_MODE},"forwarding":{"mode":"modern","secretFile":"$FORWARDING_SECRET_FILE"},"assets":[],"capabilities":{"runtime":"local-process","mountedConfig":true,"mountedSecrets":true,"mountedAssets":false}},
