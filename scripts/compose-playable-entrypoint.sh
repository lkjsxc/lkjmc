    ...
    cat >"$CONFIG_ROOT/lkjmc.json" <<JSON
{
  ...
  "network":{"name":"lkjmc-local","defaultLocale":"en","fallbackServer":"hub","onlineMode":$ONLINE_MODE,"velocityForwarding":"modern","forwardingSecretFile":"$FORWARDING_SECRET_FILE","javaEntry":{"bindHost":"$JAVA_BIND_HOST","port":$JAVA_PORT$JAVA_PUBLIC_JSON},"bedrockEntry":{"mode":"$BEDROCK","host":"127.0.0.1","port":$BEDROCK_PORT}},
