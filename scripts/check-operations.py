...
def verify(probe,overrides={}):
 ...
 if probe=='ci-compose-retained':
  ...
  require(consumer_text.index('Select preinstalled Java 21 identity runtime')<
   consumer_text.index('scripts/release_archive.py consume'),'Java 21 identity runtime is selected too late')
