...
mod tests {
  ...
  "network": {{"revision":1,"instances":[{{"id":"hub","owner":"lkjmc-daemon","kind":"folia","desiredState":"running","integration":"paper-compatible","readiness":"plugin-heartbeat","listener":"hub-java","memoryMb":1024,"assetIds":["folia"]}},{{"id":"proxy","owner":"lkjmc-daemon","kind":"velocity","desiredState":"running","integration":"velocity","readiness":"velocity-status","listener":"proxy-java","memoryMb":512,"assetIds":["velocity"]}}],"routes":[{{"id":"default","listener":"proxy-java","target":"hub","fallbacks":[]}}],"listeners":[{{"id":"hub-java","protocol":"java-tcp","bindHost":"127.0.0.1","port":25566,"publicHosts":[]}},{{"id":"proxy-java","protocol":"java-tcp","bindHost":"127.0.0.1","port":25565,"publicHosts":[]}}],"auth":{{"onlineMode":true}},"forwarding":{{"mode":"modern","secretFile":"{0}/forwarding.secret"}},"assets":[{{"id":"folia","kind":"server","path":"{0}/folia.jar","sha256":"8a87394e5a77c96ed537377b1076cce3de134f530911bcbe12d3df64af4eaa09","required":true}},{{"id":"velocity","kind":"server","path":"{0}/velocity.jar","sha256":"a6d746c480bbbef853f1535f3eb0a3ee5a5a22676dcc48204ac472054b616d6d","required":true}}],"capabilities":{{"runtime":"local-process","mountedConfig":true,"mountedSecrets":true,"mountedAssets":true}}}},
