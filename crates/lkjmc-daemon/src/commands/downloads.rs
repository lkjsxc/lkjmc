...
use crate::assets::downloads_versions::candidate_versions;
...
fn sync(state: &AppState, request: CommandEnvelope) -> Result<Value, String> {
    ...
    if project == "purpur" {
        let asset = crate::assets::purpur_downloads::sync(
            state,
            &mut client,
            minecraft_release,
    ...
    let asset = crate::assets::downloads_io::download_asset(
        state,
        &mut client,
        &project,
        &channel,
...
fn latest_versions(project: &str) -> Result<Vec<String>, String> {
    ...
    Ok(crate::assets::downloads_versions::newest_first(values))
}
...
#[rustfmt::skip]
pub(crate) struct BuildInfo { pub(crate) project: String, pub(crate) version: String, pub(crate) channel: String, pub(crate) build: i64, pub(crate) name: String, pub(crate) url: String, pub(crate) sha256: String, pub(crate) size_bytes: i64 }
