    ...
    with_connection(state, envelope, |state, envelope, client| {
        ...
        let row = store(lkjmc_store::wake_join::create_or_live(
            ...
            lkjmc_store::wake_join::NewWakeJoin {
                ...
                requested_by_kind: crate::instance_wake_runtime::actor_kind(envelope.actor.kind),
                requested_by_name: &envelope.actor.name,
                expires_in_seconds: crate::instance_wake_runtime::ttl(&envelope),
        ...
        match crate::instance_wake_runtime::wake_target(state, client, &target) {
